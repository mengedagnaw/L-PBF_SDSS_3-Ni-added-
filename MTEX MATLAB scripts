%% AS_hex.m  –  ODF φ2 sections for AS (hex EBSD, 0–90°×0–90°)
...
phi2Vals = [0 45 65]*degree;  win = [0 90];
hw = 10*degree;               res = 10*degree;
...
exportgraphics(figFerr, fullfile(outFig,"AS_Ferrite_ODF_phi2_0_45_65.png"), 'Resolution', 600);
...
exportgraphics(figAust, fullfile(outFig,"AS_Austenite_ODF_phi2_0_45_65.png"), 'Resolution', 600);

copyfile(thisFile + ".m", fullfile(outScr,"AS_hex.m"));
disp("Done: " + condLabel);
