%% SR450_hex.m  –  ODF φ2 sections for SR450 (hex EBSD, 0–90°×0–90°)
clearvars; close all; clc;

thisFile = mfilename('fullpath');
if ~isempty(thisFile), cd(fileparts(thisFile)); end

condLabel = "SR450"; fname="0.ang";
...
exportgraphics(f1,fullfile(outFig,"SR450_Ferrite_ODF_phi2_0_45_65.png"),'Resolution',600);
...
exportgraphics(f2,fullfile(outFig,"SR450_Austenite_ODF_phi2_0_45_65.png"),'Resolution',600);

copyfile(thisFile + ".m", fullfile(outScr,"SR450_hex.m"));
disp("Done: "+condLabel);
